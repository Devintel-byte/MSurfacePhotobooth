...
const DEFAULT_FILTERS = [
  { id: 298, name: 'Filter 1' },
  { id: 299, name: 'Filter 2' },
  // { id: 244, name: 'Filter 3' },
  { id: 300, name: 'Filter 4' },
  { id: 301, name: 'Filter 5' },
  { id: 19, name: 'Filter 6' },
  { id: 2, name: 'Filter 7' },
  // { id: 38, name: 'Filter 8' },
] as const;
...
export default function FilterSelection() {
  ...
  if (isFetching) {
    return (
      <div className="min-h-screen bg-orange-500 py-8 px-4 sm:px-6 lg:px-8">
        <p className="text-center uppercase mt-5 mb-5 text-lg text-white">AI PHOTOBOOTH</p>
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold text-center text-white mb-8">Loading Filters...</h1>
  ...
  return (
    <div className="min-h-screen bg-orange-500 py-8 px-4 sm:px-6 lg:px-8">
      <p className="text-center uppercase mt-5 mb-5 text-lg text-white">AI PHOTOBOOTH</p>
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold text-center text-white mb-12">Select Filter</h1>
          ...
          <button
            ...
            className={`px-8 py-3 rounded-lg font-semibold text-gray-900 transition-colors cursor-pointer ${
              selectedFilter !== null && !isLoading
                ? 'bg-white hover:bg-orange-200 shadow-lg'
