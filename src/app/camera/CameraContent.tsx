 ...
 const handleRetake = () => {
  ...
  return (
    <div className="min-h-screen bg-orange-500 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md mx-auto">
        <h1 className="text-4xl font-bold text-center text-white mb-8">Capture Photo</h1>
        <div
          ...
          {previewImage ? (
            ...
            <button
              ...
              className={`px-6 py-3 rounded-lg font-medium transition-colors cursor-pointer ${
                isCapturing ? 'bg-white text-gray-900 cursor-not-allowed' : 'bg-white hover:bg-orange-200'
              }`}
            >
